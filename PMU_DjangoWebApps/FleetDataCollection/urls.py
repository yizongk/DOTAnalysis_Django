...
from . import views
from .views import HomePageView, AboutPageView, ContactPageView, DriverAndTypeAssignmentConfirmationPageView, GetPermittedEmpDataList, UpdateM5DriverVehicleDataConfirmations, GetM5DataList, GetEmpDataList
urlpatterns = [
    ...
    path('get_m5_list', views.GetM5DataList, name='fleetdatacollection_get_m5_list'),
    path('get_pms_list', views.GetEmpDataList, name='fleetdatacollection_get_pms_list'),
