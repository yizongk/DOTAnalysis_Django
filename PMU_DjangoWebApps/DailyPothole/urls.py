...
from . import views
from .views import HomePageView, AboutPageView, ContactPageView, DataCollectionPageView, DataGridPageView, ComplaintsInputPageView, ReportsPageView, UpdatePotholesData, UpdateComplaintsData, LookupComplaintsData
urlpatterns = [
