...
from . import views
from .views import HomePageView, AboutPageView, ContactPageView, PotholeDataEntryPageView, PotholeDataGridPageView, ComplaintsInputPageView, ReportsPageView, AdminPanelPageView, UsersPanelPageView
urlpatterns = [
