class BaseAGGridCellValueSetter {
    ...
    static setAndPOST(params) { // Static so it can be called without instantiating the class
        ...
        try {
            ...
            throw `BaseAGGridCellValueSetter.setAndPOST(): ${e}`
        }
    }
}
...
class BaseAGGridCellRenderer {
    ...
    initBase(params) {
        ...
        try {
            ...
            throw `BaseAGGridCellRenderer.initBase(): ${e}`
        }
    }
...
class BaseAGGridCellSelectEditor {
    ...
    initBase(params) {
        ...
        try {
            ...
            throw `BaseAGGridCellSelectEditor.initBase(): ${e}`
        }
    }
...
class BaseAGGridCellEditor {
    ...
    initBase(params) {
        ...
        try {
            ...
            throw `BaseAGGridCellEditor.initBase(): ${e}`
        }
    }
...
class DeleteCellRenderer extends BaseAGGridCellRenderer {
    init(ag_cell) {
        try {
            ...
            throw `DeleteCellRenderer.init(): ${e}`
        }
    }
}